...
import type { Event, Day } from "./schedule-data"
...
export default function Swimlane({ day, events, totalHeight, pixelsPerMinute, startHour, width }: SwimlaneProps) {
  ...
  return (
    <div
      className="relative border-r border-border/60 flex-shrink-0 bg-gradient-to-b from-background/20 to-background/40"
      style={{
        width: `${width}px`,
        height: `${totalHeight}px`,
        backgroundImage: `repeating-linear-gradient(
          0deg,
          hsl(var(--muted) / 0.2) 1px,
          transparent 1px
        )`,
